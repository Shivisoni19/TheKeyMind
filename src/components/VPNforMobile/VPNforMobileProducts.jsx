      ...
      const VPNforMobileProducts = [
        {
          ...
          description: "$16.99",
          delprice:"$53.99",
          product_img: "img/subpages/VPNforMobile/buy-avast-secureline-vpn-pc-mac-android-ios.jpg",
        },
        {
          name: "HMA VPN 2023 - PC / MAC / LINUX / ANDROID / IOS",
          description: "$53.99",
          delprice:"$64.99",
          product_img: "img/subpages/VPNforMobile/hma-vpn-pc-mac-linux-android-ios.jpg",
        },
      ];

      setProducts(VPNforMobileProducts);
    };
