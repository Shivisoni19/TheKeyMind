        ...
        <div class="blog" id="category">
			<div class="container">
			  <div class="title block-category-top">
				<h1>
				  <i class="fa fa-star"></i> Backup & Recovery<i class="fa fa-star"></i>
				</h1>
				<div class="title-border"></div>
			  </div>
			  <div class="call-to-action">
				<p>
				  Server is available for any PC model or device on which installation is supported. We aim to always offer our customers the very best market prices on Microsoft licenses. All our software products have a lifetime license, and our customer service is always prepared to assist you in choosing the product that best suits your needs.
