...
const Terms14 = () => {
  const numbers14 = [
    {
      name: ') Liability for Other Breaches of Duty',
      elements14: [
  ...
  return (
    <>
      <div className="container terms-contents-container">
        <div className="row">
          {numbers14.map((list, index) => (
            <div className="table-contents" key={list.name}>
              <ol start={index + 14} className="outer-ol14">
                <li>
                  {list.name}
                  <ol className="inner-ol14">
                    {list.elements14.map((element14, subIndex) => (
                      <li key={subIndex}>{element14}</li>
                    ))}
                  </ol>
                </li>
              </ol>
