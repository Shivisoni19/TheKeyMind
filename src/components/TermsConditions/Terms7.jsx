  ...
  return (
    <>
      <div className="container terms-contents-container">
        <div className="row">
          {numbers7.map((list, index) => (
            <div className="table-contents" key={list.name}>
              <ol start={index + 7} className="outer-ol7">
                <li>
                  {list.name}
                  <ol className="inner-ol7">
                    {list.elements7.map((element7, subIndex) => (
                      <li key={subIndex}>{element7}</li>
                    ))}
                  </ol>
                </li>
              </ol>
