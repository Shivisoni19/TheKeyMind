  ...
  return (
    <>
      <div className="container terms-contents-container">
        <div className="row">
          {numbers6.map((list, index) => (
            <div className="table-contents" key={list.name}>
              <ol start={index + 6} className="outer-ol6">
                <li>
                  {list.name}
                  <ol className="inner-ol6">
                    {list.elements6.map((element6, subIndex) => (
                      <li key={subIndex}>{element6}</li>
                    ))}
                  </ol>
                </li>
              </ol>
